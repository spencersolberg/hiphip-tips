...
export default function Header(props: HeaderProps) {
  ...
  return (<>
    <div class="lg:flex justify-between w-full mx-auto p-4 text-white hidden">
      ...
      <a href="/" class="text-5xl mx-auto w-1/5 text-center">{Deno.env.get("HANDSHAKE_DOMAIN")}</a>
      {subdomain
        ? <a href="/account" class="text-2xl truncate w-2/5 text-right hover:italic hover:underline"><p>{subdomain}.{Deno.env.get("HANDSHAKE_DOMAIN")}</p></a>
    ...
    <div class="lg:hidden flex flex-col justify-between w-full mx-auto p-4 text-white -mb-8">
      <a href="/" class="text-5xl mx-auto text-center">{Deno.env.get("HANDSHAKE_DOMAIN")}</a>
      {subdomain
          ? <a href="/account" class="text-2xl mt-4 truncate text-center mx-auto hover:italic hover:underline"><p>{subdomain}.{Deno.env.get("HANDSHAKE_DOMAIN")}</p></a>
