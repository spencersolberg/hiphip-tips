...
export default function Header(props: HeaderProps) {
  ...
  return (<>
    <div class="lg:flex justify-between w-full mx-auto p-4 text-white hidden">
      ...
      {subdomain
        ? <a href="/account" class="text-2xl truncate w-2/5 text-right hover:italic hover:underline"><p>{subdomain}.hiphiptips</p></a>
    ...
    <div class="lg:hidden flex flex-col justify-between w-full mx-auto p-4 text-white -mb-8">
      ...
      {subdomain
          ? <a href="/account" class="text-2xl mt-4 truncate text-center mx-auto hover:italic hover:underline"><p>{subdomain}.hiphiptips</p></a>
