...
const returnSubdomainAddress = async (domain: string, symbol: string): Promise<Response> => {
...
const returnDomainAddress = async (domain: string, symbol: string): Promise<Response> => {
  try {
