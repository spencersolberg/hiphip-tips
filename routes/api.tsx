			...
			<div class="p-4 mx-auto flex max-w-screen-xl flex-col text-white min-h-screen">
				...
				<div class="flex flex-col max-w-sm md:max-w-md lg:max-w-lg mx-auto mt-4">
					...
					<p class="text-xl mt-4">
						{Deno.env.get("HANDSHAKE_DOMAIN")} offers a free API for GETting
						information about HIP-0002 domains
					</p>
					<h2 class="text-4xl mt-4 mb-2">Endpoints</h2>
					<hr />
					<h2 class="text-3xl mt-4 font-bold">Symbols</h2>
					...
					<h3 class="text-2xl mt-4 font-bold">Example</h3>
					...
					<h2 class="text-3xl mt-4 font-bold">Address</h2>
					...
					<h2 class="text-3xl mt-4 font-bold">QR Code</h2>
					<p class="text-lg mt-4 font-bold break-all md:break-normal">
					...
					<h2 class="text-4xl mt-4 mb-2">Options</h2>
					<hr />
					<h2 class="text-3xl mt-4 font-bold">Security</h2>
					<p class="text-lg mt-4 font-bold md:break-normal">
					...
					<p class="text-xl mt-4">"handshake" (default) is the most secure</p>
					<p class="text-xl mt-4">"ca" is the most compatible</p>
					<h3 class="text-2xl mt-4 font-bold">Example</h3>
					<p class="text-xl mt-4 break-all md:break-normal">
						<a
							class="underline hover:italic"
